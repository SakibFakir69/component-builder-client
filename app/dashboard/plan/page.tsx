...
interface PricingPlan {
  ...
  buttonText: string;
  isPopular: boolean;
  durationDays: number; // Add durationDays for backend
}
 ...
 const handleItem = async (item: PricingPlan) => {
  ...
  return (
    <div className={cardClasses}>
      ...
      <button onClick={() => handleItem(plan)} className={buttonClasses}>
        {plan.buttonText}
      </button>
    </div>
  );
  ...
  return (
    <section id="pricing" className="relative py-16 sm:py-24 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4">
        ...
        <Link className='flex justify-center mt-4 rounded p-1.5 bg-indigo-600 text-white' href={'/dashboard'}>
          Back to Dashboard
        </Link>
      </div>
    </section>
