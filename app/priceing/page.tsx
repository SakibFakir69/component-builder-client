...
const PricingCard: React.FC<PricingCardProps> = ({ plan }) => {
  ...
  return (
    <div className={cardClasses}>
      ...
      <button onClick={()=>handelItem(feature)} className={buttonClasses}>
        {plan.buttonText}
      </button>
    </div>
  );
  ...
  return (
    <section id="pricing" className="relative py-16 sm:py-24 overflow-hidden">
      ...
      <div className="relative container mx-auto px-4">
        ...
        <Link className='  flex justify-center mt-4 rounded p-1.5 bg-indigo-600' href={'/dashboard'}>Back to Dashboard</Link>
      </div>
    </section>
  );
};
